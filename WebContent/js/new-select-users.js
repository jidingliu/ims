...
(function($){
	...
	ShiyueUser.prototype = {
		...
		createUser:function(user,flag){
			...
			var str = '<span class="spanDis" title="'+user.name+'"><input type="checkbox" '+(checked ? 'checked="checked"':'')+' id="user-box-u-'+user.userId+'" value="'+user.userId+'"><label for="user-box-u-'+user.userId+'">'+user.name+'</label></span>';
			if(!flag){
				this._usersBox.append(str);
			}
			return str;
		...
		addSelectedUser:function(user){
			...
			if(!this.config.selectedUsers[user.userId]){
				$('<span class="spanDis" title="'+user.name+'"><input type="checkbox" checked="checked" id="user-box-u-s-'+user.userId+'" value="'+user.userId+'"><label for="user-box-u-s-'+user.userId+'">'+user.name+'</label></span>').appendTo(this._selectedUsersBox);
