...
(function($){
	...
	$.fn.multiopenaccordion = function(options, param){
		if (typeof options == 'string'){
			return $.fn.multiopenaccordion.methods[options](this, param);
		}
		...
		return this.each(function(){
			...
			if (state){
				...
				opts = $.extend({}, $.fn.multiopenaccordion.defaults, $.fn.multiopenaccordion.parseOptions(this), options);
	...
	$.fn.multiopenaccordion.parseOptions = function(target){
		var t = $(target);
	...
	$.fn.multiopenaccordion.defaults = {
		width: 'auto',
		height: 'auto',
		fit: false,
		border: true,
